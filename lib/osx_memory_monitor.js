...
metrics["phys_mem_used"] =   { id:"1644:Used Physical Memory:4", value:0, retrieveMetric: 1 };
...
function monitor()
{
	...
	ls.on('exit', function (code) {
		if (code === 127)
	   		errorHandler(new UnableToGetMetricsError('Command \'sysctl\' not found.'));
		else if (code !== 0)
	...
	for(var i in values)
	{
		...
		else if(i == 1)
		{
			...
			if (totalSwap > 0)
				...
				metrics["swap_mem_usage"].value = 0;
